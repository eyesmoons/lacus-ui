                ...
                <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="SQL脚本" prop="flinkSql">
                            <el-input v-model="form.flinkSql" type="textarea" :rows="10" placeholder="请输入SQL脚本"/>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-card>
